...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-14 max-w-[1200px] items-center gap-6 px-5 sm:h-16 sm:gap-10 sm:px-8">
        <Link
          href="/"
      ...
      >
        <nav className="mx-auto flex max-w-[1200px] flex-col gap-1 px-5 py-4" aria-label="Mobile">
          {links.map((link) => {
            const active =
              link.href === "/"
                ? pathname === "/"
